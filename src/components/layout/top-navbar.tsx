...
export function TopNavbar({ onOpenAuthModal }: TopNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full shadow-warm bg-white/90 backdrop-blur-md">
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                key={link.href}
                href={link.href}
                className="relative flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-gray-600 transition-colors hover:bg-amber-50 hover:text-amber-700"
              >
